 ...
 */
public class TitleWeek extends View {
    //上横线颜色
    private int mTopLineColor = Color.parseColor("#d8d8d8");
    //下横线颜色
    private int mBottomLineColor = Color.parseColor("#d8d8d8");
    //周一到周五的颜色
    private int mWeedayColor = Color.parseColor("#d8d8d8");
    //周六、周日的颜色
    private int mWeekendColor = Color.parseColor("#d8d8d8");
    //
    ...
    public TitleWeek(Context context, AttributeSet attrs) {
        super(context, attrs);
        mDisplayMetrics = getResources().getDisplayMetrics();
        paint = new Paint();
    ...
    public TitleWeek(Context context, AttributeSet attrs, int defStyleAttr) {
